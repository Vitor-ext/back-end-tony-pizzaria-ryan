...
app.get('/.netlify/usuarios/', cors(), async (request, response, next) => {
...
app.get('/.netlify/usuario/:id', cors(), async (request, response, next) => {
...
app.get('/.netlify/categorias/', cors(), async (request, response, next) => {
...
app.get('/.netlify/pizzas/', cors(), async (request, response, next) => {
...
app.get('/.netlify/pizzas/favoritas', cors(), async (request, response, next) => {
...
app.get('/.netlify/pizza/:id', cors(), async (request, response, next) => {
...
app.get('/.netlify/comentarios/:id', cors(), async (request, response, next) => {
...
app.get('/.netlify/bebidas/', cors(), async (request, response, next) => {
